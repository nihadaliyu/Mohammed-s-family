...
ይህ የቤተሰብ መተግበሪያ የተሠራው የኢማም ሙሀመድ ቤተሰብ ታሪክ፣ ዝምድና እና ትውልድ በቀላሉ እንዲመዘገብ እና ለወደፊት ትውልድ እንዲተላለፍ ነው።

🎯 **ዋና ዋና ዓላማዎች፦**

* የቤተሰብ አባላትን ዝርዝር፣ ግንኙነትና ታሪክ በአንድ ቦታ ማሰባሰብ
* ወደፊት የሚመጡ ትውልዶች የቤተሰባቸውን ስር እንዲያውቁ ማድረግ
* የግንኙነት መረጃ (ስልክ ቁጥር) በቀላሉ ተደራሽ እንዲሆን ማስቻል
* የቤተሰብን አንድነትና መተሳሰብ ማጠናከር

ይህ መዝገብ ለቤተሰቡ አባላት ብቻ የተዘጋጀ ሲሆን፣ በጥንቃቄ እና በኃላፊነት እንዲያዙት እንጠይቃለን።
        """)
...
<style>
  ...
  .carousel-arrow {
    ...
    color: var(--accent-dark);
    cursor: pointer;
    transition: transform .30s ease, box-shadow .25s;
  }
  ...
  .family-carousel-dot {
    ...
    border: none;
    cursor: pointer;
    transition: transform .35s, background .30s, box-shadow .35s;
  }
